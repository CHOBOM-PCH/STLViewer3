================================================================================
    MFC 라이브러리 : Preprocessor01 프로젝트 개요
================================================================================

응용 프로그램 마법사에서 이 Preprocessor01 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 
프로그램작성을 위한 기본 구조를 제공합니다.

이 파일에는 Preprocessor01 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.

Preprocessor01.vcxproj
...
Preprocessor01.vcxproj.filters
...
Preprocessor01.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CPreprocessor01App 응용 프로그램
    클래스를 선언합니다.

Preprocessor01.cpp
    응용 프로그램 클래스 CPreprocessor01App이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\Preprocessor01.ico
    응용 프로그램의 아이콘으로 사용되는 아이콘 파일입니다. 이 아이콘은
    주 리소스 파일인 Preprocessor01.rc에 의해 포함됩니다.

res\Preprocessor01.rc2
...
res\Toolbar.bmp
 ...
 리소스 편집기를 사용하여 이 도구 모음 비트맵을 편집하고
    Preprocessor01.rc의 IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음
    단추를 추가합니다.
/////////////////////////////////////////////////////////////////////////////

응용 프로그램 마법사에서 하나의 문서 형식과 하나의 뷰가 만들어집니다.

Preprocessor01Doc.h, Preprocessor01Doc.cpp - 문서
    이 파일에는 CPreprocessor01Doc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CPreprocessor01Doc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

Preprocessor01View.h, Preprocessor01View.cpp - 문서 뷰
    이 파일에는 CPreprocessor01View 클래스가 들어 있습니다.
    CPreprocessor01View 개체는 CPreprocessor01Doc 개체를 보는 데 사용됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 Preprocessor01.pch와
